...
const renderKatexUnsanitized = async (text2, config2) => {
  ...
  const { default: katex } = await import("./katex-b82f950a.js");
...
const assignWithDepth = (dst, src, { depth = 2 } = {}) => {
  const config2 = { depth };
...
const loader$m = async () => {
  const { diagram: diagram2 } = await import("./c4Diagram-033fae9a.js");
...
const loader$l = async () => {
  const { diagram: diagram2 } = await import("./flowDiagram-79e0dfe9.js");
...
const loader$k = async () => {
  const { diagram: diagram2 } = await import("./flowDiagram-v2-4768f6c4.js");
...
const loader$j = async () => {
  const { diagram: diagram2 } = await import("./erDiagram-be88f618.js");
...
const loader$i = async () => {
  const { diagram: diagram2 } = await import("./gitGraphDiagram-97ceb819.js");
...
const loader$h = async () => {
  const { diagram: diagram2 } = await import("./ganttDiagram-d256fcd3.js");
...
const loader$g = async () => {
  const { diagram: diagram2 } = await import("./infoDiagram-5b3305c8.js");
...
const loader$f = async () => {
  const { diagram: diagram2 } = await import("./pieDiagram-13a5be51.js");
...
const loader$e = async () => {
  const { diagram: diagram2 } = await import("./quadrantDiagram-44dfd0dc.js");
...
const loader$d = async () => {
  const { diagram: diagram2 } = await import("./xychartDiagram-7da22657.js");
...
const loader$c = async () => {
  const { diagram: diagram2 } = await import("./requirementDiagram-e2ee1dc5.js");
...
const loader$b = async () => {
  const { diagram: diagram2 } = await import("./sequenceDiagram-57e74c81.js");
...
const loader$a = async () => {
  const { diagram: diagram2 } = await import("./classDiagram-0679674d.js");
...
const loader$9 = async () => {
  const { diagram: diagram2 } = await import("./classDiagram-v2-3cab3e5a.js");
...
const loader$8 = async () => {
  const { diagram: diagram2 } = await import("./stateDiagram-c9a738c8.js");
...
const loader$7 = async () => {
  const { diagram: diagram2 } = await import("./stateDiagram-v2-cf9434d3.js");
...
const loader$6 = async () => {
  const { diagram: diagram2 } = await import("./journeyDiagram-f10e300e.js");
...
const loader$5 = async () => {
  const { diagram: diagram2 } = await import("./flowchart-elk-definition-0b0922ba.js");
...
const loader$4 = async () => {
  const { diagram: diagram2 } = await import("./timeline-definition-71588742.js");
...
const loader$3 = async () => {
  const { diagram: diagram2 } = await import("./mindmap-definition-09e56b3b.js");
...
const loader$2 = async () => {
  const { diagram: diagram2 } = await import("./sankeyDiagram-3a0929ee.js");
...
const loader$1 = async () => {
  const { diagram: diagram2 } = await import("./blockDiagram-59d89362.js");
...
const compileCSS = (namespace2, css) => {
  return serialize(
    compile(`${namespace2}{${css}}`),
    middleware([
...
const render$1 = async function(id2, text2, svgContainingElement) {
  ...
  let root2 = d3select(document.body);
  ...
  if (svgContainingElement !== void 0) {
    ...
    if (isSandboxed) {
      const iframe = sandboxedIframe(d3select(document.body), iFrameID);
      root2 = d3select(iframe.nodes()[0].contentDocument.body);
      root2.node().style.margin = "0";
    } else {
      root2 = d3select("body");
